...
import { ArrowRight, Brain, Target, TrendingUp, CheckCircle2, Zap } from 'lucide-react';
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href={dashboardLink} className="w-full sm:w-auto text-base font-semibold bg-white text-slate-900 px-8 py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-slate-100 transition-all">
        ...
        <section className="py-24 relative overflow-hidden border-t border-slate-800/50">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 text-lg font-bold bg-teal-500 hover:bg-teal-400 text-slate-950 px-8 py-4 rounded-xl transition-colors shadow-lg shadow-teal-500/25"
            >
              {user ? "Go to Dashboard" : "Sign Up Free Now"} <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </section>
      </div>
